    ...
    def process(self,face_image:np.ndarray,user_code:str) -> Tuple[np.ndarray,bool,str]:
        ...
        if check_face_center:
            ...
            if len(face_points) < 2:
                return face_image,False,"Not enough keypoints for alignment"
            ...
            return face_image,check_save_image,"¡Face saved successfully!"

        else:
            return face_image,False,"Face not centered"
